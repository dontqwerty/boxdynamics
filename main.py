...
env.create_moving_obstacle(pos=(10,20), size=(10,10), velocity=(10,10))
# env.create_moving_obstacle(pos=(20,20), size=(10,10), velocity=(10,0))
# env.create_moving_obstacle(pos=(30,20), size=(10,10), velocity=(0,10))
# env.create_moving_zone(pos=(40,20), size=(10,10), velocity=(10,10))
# env.create_moving_zone(pos=(50,20), size=(10,10), velocity=(10,0))
env.create_moving_zone(pos=(60,20), size=(10,10), velocity=(0,10))
